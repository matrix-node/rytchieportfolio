...
import { Image, Eye, Compass, Info } from 'lucide-react';
              ...
              {filteredItems.map((item) => (
                ...
                >
                  ...
                  <img
                    ...
                    className="absolute inset-0 w-full h-full object-cover opacity-70 group-hover:scale-105 group-hover:opacity-90 transition-all duration-700 pointer-events-none"
                  />
