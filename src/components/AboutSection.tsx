          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="relative group max-w-md mx-auto lg:mx-0">
              ...
              <div className="overflow-hidden rounded-md border border-[#3a494a]/30 bg-[#12121A] relative shadow-2xl">
                <img
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuAAJizcHmgGL1v6rRj5ghhjwqxVJ99jMlTnY5rz2oxTuIz7p9fE_f35ODcQG0CgrKIpgDBb6EryDI_Xnqav4PYdYtyAvZuywATfQ_M6s_n2e1CGFJE0GX_ziCJrY79FBE45n7mGZhU9dzgQFviLezyjXyRnfEjhm6VBrHT_v2FxtrUjmo4jpHQ3ZHc7X6AATowPZQO2hFFYf0g2_VYS9JyWFzX3zo9mCswwF9cws0wg8zdfb_7rwksWDeJidYwKn0l4Z10StrRNG4Lk"
                  alt="Rytchie Macharia thinking visual mode"
                  loading="lazy"
                  referrerPolicy="no-referrer"
                  className="w-full h-[380px] object-cover filter grayscale opacity-75 group-hover:grayscale-0 group-hover:opacity-95 transition-all duration-700"
                />
